...
import com.scf.utils.support.json.DefaultDateFormatDeserializer;
...
public class FastJsonUtils {
    ...
    public static <T> T fromJSONString(String json, Class<T> clazz, String dateFormat) {
        if (StringUtils.isNotBlank(dateFormat)) {
            ParserConfig.getGlobalInstance().putDeserializer(Date.class, new DefaultDateFormatDeserializer(dateFormat));
        }
        return JSON.parseObject(json, clazz, deSerializerFeatures);
    }

...
public class EncodesUtilies {
	...
	public static String encodeUrlSafeBase64(String input) {
	    ...
	    try {
            return new String(Base64.encodeBase64URLSafe(input.getBytes(DEFAULT_URL_ENCODING)), DEFAULT_URL_ENCODING);
     ...
     * Base64编码.
     */
    public static String encodeBase64(byte[] inputs) {
            try {
                return new String(Base64.encodeBase64(inputs),DEFAULT_URL_ENCODING);
            } catch (UnsupportedEncodingException e) {
                throw ExceptionsUtilies.unchecked(e);
            }
    }
